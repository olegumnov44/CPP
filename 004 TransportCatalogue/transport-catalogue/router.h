  ...
  template <typename Weight>
  const typename Router<Weight>::RouteInternalData*
  Router<Weight>::GetRouteInternalData(VertexId from, VertexId to) const {
  ...
  Router<Weight>::BuildRoute(VertexId from,
                                                                               VertexId to) const {
