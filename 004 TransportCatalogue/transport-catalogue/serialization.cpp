  ...
  TransportCatalogue
  DeserializeTransportCatalogue(transport_catalogue_proto::Catalogue&& proto)
  {
  ...
  transport_catalogue_proto::RenderSettings SerializeRenderSettings(const
  ...
  renderer::RenderSettings DeserializeRenderSettings(const
  transport_catalogue_proto::RenderSettings& proto) {
      renderer::RenderSettings settings;
  ...
  template <typename Weight>
  graph_proto::DirectedWeightedGraph SerializeGraph(const
  graph::DirectedWeightedGraph<Weight>& source_graph) {
  ...
  template <typename Weight>
  graph::DirectedWeightedGraph<Weight> DeserializeGraph(const
  graph_proto::DirectedWeightedGraph& proto) {
  ...
  template <typename Weight>
  graph::Router<Weight> DeserializeRouter(const graph_proto::Router& proto,
  const graph::DirectedWeightedGraph<Weight>& target_graph) {
  ...
  transport_catalogue_proto::RoutingSettings SerializeRoutingSettings(const
  ...
  router::RoutingSettings DeserializeRoutingSettings(const
  transport_catalogue_proto::RoutingSettings& proto) {
      router::RoutingSettings settings;
  ...
  router::Router DeserializeTransportRouter(const
  transport_catalogue_proto::TransportRouter& proto, const
  TransportCatalogue& db) {
  ...
  std::tuple<TransportCatalogue, renderer::MapRenderer, router::Router>
  DeserializeUniverse(
      transport_catalogue_proto::TransportCatalogue&& proto
  ) {
