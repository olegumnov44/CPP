  ...
  std::optional<BusStat> RequestHandler::GetBusStat(std::string_view
  bus_name) const {
  ...
  std::optional<router::RouteInfo> RequestHandler::FindRoute(std::string_view
  stop_name_from, std::string_view stop_name_to) const {
