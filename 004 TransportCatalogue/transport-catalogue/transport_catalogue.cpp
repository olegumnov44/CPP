  ...
  std::vector<StopPtr> CreateEndpoints(const std::vector<std::string>&
  stop_names,
  ...
  std::vector<StopPtr> CreateBusStops(const std::vector<std::string>&
  stop_names, bool is_roundtrip,
                                      const TransportCatalogue& catalogue) {
  ...
  void TransportCatalogue::AddBus(std::string name, std::vector<StopPtr>
  stops,
                                  std::vector<StopPtr> endpoints) {
  ...
  TransportCatalogue::GetBusesByStop(StopPtr stop) const {
  ...
  TransportCatalogueBuilder& TransportCatalogueBuilder::AddBus(BusDesc
  bus_desc) {
      bus_descriptions_.emplace_back(std::move(bus_desc));
      return *this;
  }
  
  TransportCatalogueBuilder& TransportCatalogueBuilder::AddStop(StopDesc
  stop_desc) {
